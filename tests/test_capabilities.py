...
class TestCopyCapabilityTemplates(unittest.TestCase):
    ...
    def test_copy_creates_proto_gear_directory(self):
        ...
        result = copy_capability_templates(self.test_path, "TestProject", dry_run=False)
    ...
    def test_placeholder_replacement(self):
        ...
        result = copy_capability_templates(
            self.test_path, "MyProject", version="0.4.0", dry_run=False
        )
    ...
    def test_dry_run_no_files_created(self):
        ...
        result = copy_capability_templates(self.test_path, "TestProject", dry_run=True)

        self.assertEqual(result["status"], "success")
        self.assertFalse((self.test_path / ".proto-gear").exists())
        self.assertGreater(
            len(result["files_created"]), 0
    ...
    def test_files_created_list_populated(self):
        ...
        self.assertTrue(
            any(
                ".proto-gear/INDEX.md" in f or "INDEX.md" in f
...
class TestCapabilitySecurityValidation(unittest.TestCase):
    ...
    def test_path_traversal_rejected(self):
        ...
        result = copy_capability_templates(
            self.test_path / ".." / "malicious", "TestProject", dry_run=True
        )
...
class TestCapabilityPlaceholders(unittest.TestCase):
    ...
    def test_version_placeholder_replaced(self):
        ...
        result = copy_capability_templates(
            self.test_path, "TestProject", version="0.4.0", dry_run=False
        )
    ...
    def test_project_name_placeholder_replaced(self):
        ...
        result = copy_capability_templates(
            self.test_path, "MyAwesomeProject", dry_run=False
        )
...
class TestCapabilityErrorHandling(unittest.TestCase):
    ...
    def test_invalid_project_path(self):
        ...
        result = copy_capability_templates(
            Path("/nonexistent/path/that/does/not/exist"), "TestProject", dry_run=True
        )
    ...
    def test_empty_project_name(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = copy_capability_templates(Path(tmpdir), "", dry_run=False)
    ...
    def test_none_project_name(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = copy_capability_templates(Path(tmpdir), None, dry_run=False)
...
class TestCapabilityDryRun(unittest.TestCase):
    ...
    def test_dry_run_includes_all_expected_files(self):
        ...
        self.assertTrue(
            any("workflows" in f and "INDEX.md" in f for f in files_created)
        )
