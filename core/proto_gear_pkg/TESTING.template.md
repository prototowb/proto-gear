  ...
  python_examples:
    ...
    content: |
      ...
      **Mocking with unittest.mock:**
      ...
      @patch('{{PROJECT_NAME}}.api.requests.get')
      def test_api_call_with_retry(mock_get):
          """API should retry on failure"""
      ...
      **Parametrized Tests:**
      ...
      def test_number_to_word(input, expected):
          """Number conversion should handle various inputs"""
...
import pytest
from {{PROJECT_NAME}}.{{MODULE_NAME}} import calculate_total
...
import pytest
from {{PROJECT_NAME}}.api import create_user
from {{PROJECT_NAME}}.database import UserRepository
...
*Generated by Proto Gear v{{VERSION}} - AI Agent Framework for Intelligent Development Workflows*
