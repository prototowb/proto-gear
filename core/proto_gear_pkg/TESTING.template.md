# {{PROJECT_NAME}} - Testing Strategy & TDD Workflow
...
This document defines the testing methodology and Test-Driven Development (TDD) workflow for {{PROJECT_NAME}}. Following these patterns ensures quality, maintainability, and confidence in code changes.

**Core Principle**: Tests are written BEFORE implementation, not after.
