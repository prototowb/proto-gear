...
# For bug fixes
git checkout -b bugfix/{{TICKET_PREFIX}}-XXX-description
```
...
```bash
git push origin feature/{{TICKET_PREFIX}}-XXX-description
```
...
By contributing to {{PROJECT_NAME}}, you agree that your contributions will be licensed under {{LICENSE}}.

---

## Thank You!

Your contributions make {{PROJECT_NAME}} better for everyone. We appreciate your time and effort!

**Questions?** {{CONTACT_INFO}}

---

*This contributing guide was generated by Proto Gear and customized for {{PROJECT_NAME}}.*
