...
4. Follow the project's established patterns5. Follow branching and commit conventions in BRANCHING.md
...
2. Check PROJECT_STATUS.md for current project state3. Review BRANCHING.md for Git workflow conventions
